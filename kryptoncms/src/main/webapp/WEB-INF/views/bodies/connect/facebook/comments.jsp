...
<c:set var="baseURL" value="${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}" />
<c:url var="relativeCommentableUrl" value="/${commentableType}/${commentableId}" />
