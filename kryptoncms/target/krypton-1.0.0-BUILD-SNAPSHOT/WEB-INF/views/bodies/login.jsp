...
<form action="<c:url value='/j_spring_security_check' />" method="post"
	class="membership_login" style="margin-bottom: 0px" data-validation-enable>
...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
	...
	<div>
		<div class="control-group input-prepend input-append">
			...
			</label> <input type="text" class="pull-left" id="username" name="j_username"
				placeholder="Username" data-required
				data-describedby="username-description" data-description="username"
				data-pattern=".{3,}" /> <label
				id="username-description" for="username" class="add-on"></label>
		</div>
	</div>
	<div>
		<div class="control-group input-prepend input-append">
			<label for="password" class="add-on pull-left"> <span
				...
				data-pattern=".{5,}" /> <label for="password"
				class="add-on" id="password-description"></label>
		</div>
	</div>
	</div>
